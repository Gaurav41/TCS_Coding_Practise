/*
 Display sequence of Fibonacci series until the number given by user and count total even number and 
 odd numbers in that series expect zero.
...
The text message should be displayed in exact format as it is case sensitive.

In below example 2 is for count of even numbers that is (2,8) and 4 is count of odd number 
thats (1,1,3,5,13).
