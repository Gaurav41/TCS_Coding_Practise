...
You need to record their oxygen level after every round.
 After trainee are finished with all rounds, calculate for each trainee his average oxygen level 
 over the 3 rounds and select one with highest oxygen level as the most fit trainee. 
...
Output must be in the given format as in above example. For any wrong input final output should display 
“INVALID INPUT”
