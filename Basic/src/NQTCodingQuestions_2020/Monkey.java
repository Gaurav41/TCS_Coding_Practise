...
If every Monkey can eat k Bananas and j Peanuts. If total m number of Bananas and p number 
...
left on the ground or less than j Peanuts left on the ground, only that Monkey can eat Bananas(<k) 
along with the Peanuts(<j).
